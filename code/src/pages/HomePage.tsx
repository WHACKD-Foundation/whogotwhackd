      ...
      <Container>
        <Section>
          ...
          <ContentBlock>
            {whackdCounter &&
              <ContentRow>
              <Label>Counter is at:</Label> <TextInline>{whackdCounter}</TextInline>
            </ContentRow>
            }
            {account && (
              <ContentRow>
            ...
            {userBalance && (
              <ContentRow>
                <Label>WHACKD balance:</Label> <TextInline>{formatEther(userBalance)}</TextInline> <Label>WHACKD</Label>
              </ContentRow>
            )}
          </ContentBlock>
        </Section>
